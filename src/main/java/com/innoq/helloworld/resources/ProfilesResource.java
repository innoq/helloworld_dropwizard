...
public class ProfilesResource {
	...
	public ProfilesResource(EntityManagerFactory emf) {
		this.emf = emf;
	}
	...
	public String getAll() {
		...
		for (Profile profile : profileList) {
			response.append(profile.getId()).append(": ").append(profile.getFullName()).append("\n");
		}
	...
	public ProfileView getById(@PathParam("id") Long id) {
		...
		return new ProfileView(profile, "private.ftl");
	}
}
